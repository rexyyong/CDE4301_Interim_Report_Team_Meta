      ...
      data: [
        ...
        [
          ...
          gridjs.html(`
            ...
            <strong>Need for in-the-moment decision support:</strong> Beyond just training, social workers need real-time help during stressful encounters. They need "prompts" that can help them regulate their own emotions and the elderly's emotions, allowing them to remain "grounded" and "confident" when "unexpected things occur," rather than feeling "shocked."<br><M>
